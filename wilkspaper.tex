...
and typically form a surprisingly regular array over the support of the Wigner semicircle.  Since our goal is to compute $\expect{\lambda}_{\mathrm{kite}}$, we can capitalize on this behavior by replacing each random sample of $\bvec{\kappa}$ with a 
