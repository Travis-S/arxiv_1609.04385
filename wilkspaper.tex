...
In this section, we show how to derive a replacement for the Wilks theorem that is valid for rank-deficient $\rho_{0}$. To do so, we define a replacement for LAN in the presence of boundaries, which we call \emph{Local Asymptotic Metric-Projected Normality}.
...
\subsubsection{Complete Expression for $\langle \lambda \rangle$}
