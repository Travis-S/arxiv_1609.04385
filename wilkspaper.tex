...
In this case, $\rhohat$ is often negative (see Figure \ref{fig:boundaries}). For each such $\rhohat$, the actual $\rhoMLE$ is the solution to the following optimization problem:
\begin{equation}
\label{eq:mleopt}
